...
DROP TABLE IF EXISTS pointstocount_fix1;
DROP TABLE IF EXISTS pointstocount_fix2;
DROP TABLE IF EXISTS pointstocount_copy1;
DROP TABLE IF EXISTS pointstocount_copy2;
