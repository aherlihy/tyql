...
// // TODO: report bug? if AllRows (named tuple) is not a type alias the compiler won't find the given
...
//   def testDescription: String = "Select: select with nested loop, 1 table"
//   def query() =
//     for
...
//   def testDescription: String = "Select: select with 1 join, 2 tables, 1 row type"
//   def query() =
//     for
//       city <- testDB.tables.cities
